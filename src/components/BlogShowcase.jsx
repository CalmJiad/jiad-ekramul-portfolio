  ...
  return (
    <section className="h-[calc(100svh-80px)] snap-start pt-24 ">
      <div className="flex items-center justify-center w-[75%] h-full mx-auto">
        <div className="max-w-[1366px] h-full m-auto flex gap-12 items-center justify-center overflow-hidden">
          <div ref={ref} className="h-[50%] w-full">
            <img
          ...
          >
            <h2 className="text-[2.55rem] text-white">{item.title}</h2>
  ...
  return (
    ...
    >
      <div className="bg-[#0b1221] sticky top-0 left-0 pb-16 pt-20 text-center text-orange-400 text-3xl z-10">
        <h1 className="pb-4 font-cute-font text-7xl">Recent Articles</h1>
