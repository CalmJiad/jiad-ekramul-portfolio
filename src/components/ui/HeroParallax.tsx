...
export const HeroParallax = ({ products }) => {
  ...
  return (
    <div
      ref={ref}
      className="2xl:h-[340vh] xl:h-[240vh] lg:h-[300vh] md:h-[300vh] h-[240vh] py-40 overflow-hidden  antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
