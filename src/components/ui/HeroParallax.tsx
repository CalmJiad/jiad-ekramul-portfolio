...
export const HeroParallax = ({ products }) => {
  ...
  const thirdRow = products.slice(10, 20);
  ...
  return (
    <div
      ref={ref}
      className="2xl:h-[340vh] xl:h-[240vh] lg:h-[300vh] md:h-[300vh] h-[210vh] py-40 overflow-hidden  antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
        ...
        className=""
      >
        <motion.div className="flex flex-row-reverse space-x-reverse space-x-12 mb-20">
        ...
        <motion.div className="flex flex-row mb-20 space-x-12">
